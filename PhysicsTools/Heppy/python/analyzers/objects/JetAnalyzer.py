    ...
    def smearJets(self, event, jets):
       ...
       for jet in jets:
            ...
            if gen != None:
               ...
               # from https://twiki.cern.ch/twiki/bin/view/CMS/JetResolution#MC_truth_JER_at_13_TeV_new
               #13 TeV tables
               factor = 1.320 + self.shiftJER*0.286
               if   aeta > 3.2: factor = 1.303 + self.shiftJER * 0.111
               elif aeta > 3.0: factor = 1.343 + self.shiftJER * 0.123
               elif aeta > 2.5: factor = 1.126 + self.shiftJER * 0.094
               elif aeta > 1.9: factor = 1.106 + self.shiftJER * 0.030
               elif aeta > 1.3: factor = 1.088 + self.shiftJER * 0.029
               elif aeta > 0.8: factor = 1.061 + self.shiftJER * 0.023               
